...
try {
    ...
    if (empty($searchResults)) {
        echo "<script>alert('Sorry, we couldn't find any staff matching your search criteria.');</script>";
    }
...
<head>
    ...
    <title>Nurse - Staff Directory</title>
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item <?php echo ($current_page == 'nurseliststaff.php') ? 'active' : ''; ?>">
...
<table id="staffTable" class="table table-striped">
    ...
    <tr>
        <td colspan="8" class="text-center" style="font-weight: bold; color: red;">
