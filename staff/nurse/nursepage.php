...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item <?php echo ($current_page == 'nursepage.php') ? 'active' : ''; ?>">
...
<!-- Content Of The Page -->
        <div class="content">
            ...
            <div class="options">
                <a href="https://172.20.238.6/staff2/nurse/nursedashboard.php?staffid=<?php echo $staffID; ?>">Real-Time Dashboard</a>
                <a href="https://172.20.238.6/staff2/nurse/nurseliststaff.php?staffid=<?php echo $staffID; ?>">Staff Directory</a>
                <a href="https://172.20.238.6/staff2/nurse/nurselistdept.php?staffid=<?php echo $staffID; ?>">Department Directory</a>
                <a href="https://172.20.238.6/staff2/nurse/nurseprofile.php?staffid=<?php echo $staffID; ?>">Profile</a>
            </div>
        </div>
</body>
</html>