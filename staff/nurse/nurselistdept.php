...
<head>
    ...
    <title>Nurse - Department Directory</title>
    <!-- DataTables CSS -->
    ...
    <!-- Bootstrap CSS (Only one needed, use the latest version) -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome CSS (Use the latest version) -->
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item <?php echo ($current_page == 'nurselistdept.php') ? 'active' : ''; ?>">
