...
try {
    ...
    if (isset($_POST['update'])) {
        ...
        if ($hasError) {
            ...
            header("Location: doctorprofile.php?staffid=$staffID");
            exit();
        }
        ...
        try {
            ...
            if ($updateStmtAzwarie) {
                ...
                if ($updateStmtAzwarie->execute()) {
                    ...
                    logAuditTrail($pdo, $staffID, 'Profile Update', 'Staff updated their profile details.');
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item <?php echo ($current_page == 'https://172.20.238.6/staff2/doctor/doctordashboard.php') ? 'active' : ''; ?>">
                    <a class="nav-link" href="https://172.20.238.6/staff2/doctor/doctordashboard.php?staffid=<?php echo $staffID; ?>"  style="color: black;">Real-Time Dashboards</a>
                </li>
                ...
                <li class="nav-item <?php echo ($current_page == 'doctorprofile.php') ? 'active' : ''; ?>">
        ...
        <div class="section" id="personalDetails">
            <div class="section-content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="ic" name="ic" value="<?php echo htmlspecialchars($staff['ic']); ?>" readonly oninput="validateIC()">
