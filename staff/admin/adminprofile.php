...
try {
    ...
    if (isset($_POST['update'])) {
        ...
        if ($hasError) {
            ...
            header("Location: adminprofile.php?staffid=$staffID");
            exit();
        }
        ...
        try {
            ...
            if ($updateStmtAzwarie) {
                ...
                $updateStmtAzwarie->bind_param("sssssss", $name, $phoneno, $address, $email, $username, $password, $staffID);
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown <?php echo ($current_page == 'admindashboard.php' || $current_page == 'dashboardReports.php' || $current_page == 'analytics.php' || $current_page == 'performanceMetrics.php') ? 'active' : ''; ?>" style="position: relative;">
                    <a 
                        class="nav-link dropdown-toggle" 
                        href="#" 
                        id="realTimeDashboardsDropdown" 
                        role="button" 
                    ...
                    <ul class="dropdown-menu" aria-labelledby="realTimeDashboardsDropdown">
                        <li>
                            <a class="dropdown-item <?php echo ($current_page == 'admindashboard.php') ? 'active' : ''; ?>" 
                                href="admindashboard.php?staffid=<?php echo $staffID; ?>">Dashboard Overview</a>
                        </li>
                        <li>
                            <a class="dropdown-item <?php echo ($current_page == 'dashboardReports.php') ? 'active' : ''; ?>" 
                                href="adminaudittrail.php?staffid=<?php echo $staffID; ?>">Audit Trail Records</a>
                        </li>
                    </ul>
                </li>
    ...
    <form method="POST">
        <div class="section-titles">
            ...
            <div class="section-title" onclick="toggleSection('jobDetails')">
                <i class="fa fa-briefcase" aria-hidden="true"></i>Job Details
            </div>
        ...
        <div class="section" id="personalDetails">
            <div class="section-content">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($staff['name']); ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="ic">NRIC:</label>
                    <input type="text" id="ic" name="ic" value="<?php echo htmlspecialchars($staff['ic']); ?>" readonly>
                    <span id="icError" style="color:red;"></span>
                </div>
                <div class="form-group">
                    <label for="gender">Gender:</label>
                    <input type="text" id="gender" name="gender" value="<?php echo htmlspecialchars($staff['gender']); ?>" readonly>
                </div>
                <div class="form-group">
...
<script>
    function handleEdit() {
        // Set a hidden input field to indicate edit mode
        const editInput = document.createElement('input');
        editInput.type = 'hidden';
        editInput.name = 'edit';
        editInput.value = 'true';
        document.getElementById('profileForm').appendChild(editInput);
