    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown <?php echo ($current_page == 'menudashboard.php' ||'admindashboard.php' || $current_page == 'adminaudittrail.php') ? 'active' : ''; ?>" style="position: relative;">
                    <a 
                    ...
                    <ul class="dropdown-menu" aria-labelledby="realTimeDashboardsDropdown">
                        ...
                        <li>
                            <a class="dropdown-item <?php echo ($current_page == 'adminaudittrail.php') ? 'active' : ''; ?>" 
...
<div class="hero-section">
        ...
        <div class="content">
            <div class="options">
            <a href="admindashboard.php?staffid=<?php echo $staffID; ?>">Dashboard Overview</a>
            <a href="adminaudittrail.php?staffid=<?php echo $staffID; ?>">Audit Trail Records</a>
            </div>
        </div>
<script>
// Get the button
