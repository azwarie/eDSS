...
<head>
    ...
    <title>Admin Menu Manage Staff</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown <?php echo ($current_page == 'admindashboard.php' || $current_page == 'adminaudittrail.php') ? 'active' : ''; ?>" style="position: relative;">
                    <a 
                ...
                <li class="nav-item dropdown <?php echo ($current_page == 'menumanage' || 'viewStaff.php' || $current_page == 'registerStaff.php' || $current_page == 'removeStaff.php' || $current_page == 'updateStaff.php') ? 'active' : ''; ?>" style="position: relative;">
                    <a 
                        class="nav-link dropdown-toggle" 
                        href="#" 
...
<div class="hero-section">
        ...
        <div class="content">
            <div class="options">
            <a href="viewStaff.php?staffid=<?php echo $staffID; ?>">Staff Directory</a>
            <a href="registerStaff.php?staffid=<?php echo $staffID; ?>">Register Staff</a>
            <a href="removeStaff.php?staffid=<?php echo $staffID; ?>">Remove Staff</a>
            <a href="updateStaff.php?staffid=<?php echo $staffID; ?>">Update Staff</a>
            </div>
        </div>
<script>
// Get the button
