    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item <?php echo ($current_page == 'AdminLandingPage.php') ? 'active' : ''; ?>">
                <a class="nav-link" href="https://172.20.238.6/staff2/admin/AdminLandingPage.php?staffid=<?php echo $staffID; ?>" style="color: black;">Home</a>
            </li>
            ...
            <li class="nav-item <?php echo ($current_page == 'http://localhost/dss/admission/admin/index.php') ? 'active' : ''; ?>">
                ...
                <li class="nav-item <?php echo ($current_page == 'http://172.20.238.6//staff2/logout.php') ? 'active' : ''; ?>">
                    <a class="nav-link" href="http://172.20.238.6//staff2/logout.php" style="color: black;">Logout</a>
                </li>
            </ul>
        </div>
    </div>
...
<!-- Content Of The Page -->
    <div class="content">
        <h1>Welcome to the WeCare Decision Support System</h1>
