        ...
        if (empty($errors)) {
            ...
            try {
                if (!empty($edStay_StayID_form) && $isCheckoutAction) { // CHECK-OUT
                    ...
                    $role_checkin_staff = ROLE_CHECKIN_STAFF;
                    $sql_log_checkin_staff = "INSERT INTO edstay_staff_roles (StayID, StaffID, Role, ActivityTimestamp) VALUES (?, ?, ?, NOW())";
                    $stmt_log_checkin = $conn->prepare($sql_log_checkin_staff);
                    if ($stmt_log_checkin) { $stmt_log_checkin->bind_param("sss", $new_stay_id, $loggedInStaffID_Session, $role_checkin_staff); if (!$stmt_log_checkin->execute()) { error_log("Failed log CheckInStaff for Stay {$new_stay_id}: " . $stmt_log_checkin->error); } $stmt_log_checkin->close(); } else { error_log("Prep fail CheckInStaff log: " . $conn->error); }
...
<html lang="en">
<head>
    <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>ED Check-In & Triage - eDSS</title> <link rel="preconnect" href="https://fonts.googleapis.com"> <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin> <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&display=swap" rel="stylesheet"> <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;700&display=swap" rel="stylesheet"> <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"> <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">
    <style>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
       ...
       <a class="navbar-brand" href="<?php echo addStaffIdToLink('http://localhost/dss/staff/nurse/NurseLandingPage.php', $staffIdForPageContext); // Link to AdminLandingPage ?>">eDSS</a>
