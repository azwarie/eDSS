...
INSERT INTO `BED` (`BedID`,`BedStatus`,`DateAdded`,`inventoryID`) VALUES ('B023','available','2025-01-19 17:23:53','INV063');
INSERT INTO `BED` (`BedID`,`BedStatus`,`DateAdded`,`inventoryID`) VALUES ('B024','available','2025-01-19 17:23:53','INV063');
INSERT INTO `BED` (`BedID`,`BedStatus`,`DateAdded`,`inventoryID`) VALUES ('B025','available','2025-01-19 17:23:53','INV063');
INSERT INTO `BED` (`BedID`,`BedStatus`,`DateAdded`,`inventoryID`) VALUES ('B026','available','2025-01-19 17:23:53','INV063');
INSERT INTO `BED` (`BedID`,`BedStatus`,`DateAdded`,`inventoryID`) VALUES ('B027','available','2025-01-19 17:23:53','INV063');
...
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125023','A007','2025-01-19 17:41:05','2025-01-19 17:43:11','Alzheimer and Other Degenerative Diseases','B026','P044','A00001');
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125024','A007','2025-01-19 17:47:47','2025-01-19 17:48:52','CNS Cancer (Brain, Eye)','B023','P039','N00001');
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125025','A007','2025-01-19 17:50:01','2025-01-19 17:51:52','CNS Cancer (Brain, Eye)','B023','P039','N00001');
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125026','A006','2025-01-19 17:32:49','2025-01-19 17:51:54','Thyroid Disorders','B025','P042','A00001');
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125027','A005','2025-01-19 17:29:54','2025-01-19 17:51:57','Other Bacterial Infections','B027','P004','A00001');
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125028','A004','2025-01-17 16:26:09','2025-01-19 17:51:59','Lung Diseases','B018','P046','A00001');
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125029','A003','2025-01-16 17:56:00','2025-01-19 17:52:01','Skin Infections and Disorders','B019','P048','A00001');
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125030','A002','2025-01-16 17:21:58','2025-01-19 17:52:03','Intestinal Infections','B021','P001','N00002');
INSERT INTO `PAST_ADMISSION` (`PastAdmissionID`,`AdmissionID`,`AdmissionDateTime`,`DischargeDateTime`,`ReasonForAdmission`,`BedID`,`PatientID`,`StaffID`) VALUES ('PA0125031','A001','2025-01-16 16:14:24','2025-01-19 17:52:06','Viral Fevers and Hemorrhagic Fevers','B022','P050','N00002');
