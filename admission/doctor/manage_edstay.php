...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
       ...
       <a class="navbar-brand" href="<?php echo addStaffIdToLink('http://localhost/dss/staff/admin/AdminLandingPage.php', $staffIdForPageContext); // Link to AdminLandingPage ?>">WeCare</a>
