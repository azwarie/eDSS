...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="<?php echo addStaffIdToLink('https://localhost/dss/staff/doctor/DoctorLandingPage.php', $staffIdToUseInNavbarLinks); ?>" style="font-family: 'Montserrat', sans-serif; font-size: 1.5rem; font-weight: 700; color: #007bff; position: absolute; top: 10px; left: 15px;">eDSS</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item <?php echo ($current_page == 'index.php' || $current_page == 'index.php') ? 'active' : ''; ?>">
