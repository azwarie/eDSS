...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="<?php echo addStaffIdToLink('https://localhost/dss/staff/admin/AdminLandingPage.php', $staffIdToUseInNavbarLinks); ?>" style="font-family: 'Montserrat', sans-serif; font-size: 1.5rem; font-weight: 700; color: #007bff; position: absolute; top: 10px; left: 15px;">WeCare</a>
            ...
            <div class="action-section" id="diagnosisActionSection">
                ...
                <?php if ($currentStatusForDisplay == 'Waiting for Doctor'): ?>
                    <form method="POST" class="mb-3" action="<?php echo addStaffIdToLink(htmlspecialchars($_SERVER['PHP_SELF']), $staffIdToUseInNavbarLinks) . '&selected_stay_id=' . urlencode($selected_stay_id); ?>">
                        ...
                        <input type="hidden" name="selected_stay_id_from_action" value="<?php echo htmlspecialchars($selected_stay_id); ?>"> {/* To re-select after POST */}
