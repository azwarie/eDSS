...
<head>
    ...
    <title>Patient Diagnosis Dashboard - WeCare</title>
...
<a class="navbar-brand" href="<?php echo addStaffIdToLink('https://localhost/dss/staff/admin/AdminLandingPage.php', $staffIdToUseInNavbarLinks); ?>" style="font-family: 'Montserrat', sans-serif; font-size: 1.5rem; font-weight: 700; position: absolute; top: 10px; left: 15px;">WeCare</a>
...
<style>
    ...
    <footer><p>© <?php echo date("Y"); ?> WeCare Patient Management. All rights reserved.</p></footer>
